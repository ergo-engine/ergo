...
**Status:** Amended in orchestration/supervisor.md v0 (2026-01-11).
...
- [x] Create `crates/kernel/adapter/src/manifest.rs` with schema structs
- [x] Create `crates/kernel/adapter/src/validate.rs` with rule checks
...
- [x] Create adapter.md (v1 adapter contract); do not modify frozen docs
- [x] Add ADP-* invariants to invariants/INDEX.md
- [x] Add COMP-* invariants to invariants/INDEX.md
...
- [x] Update source.md
- [x] Remove `context` from source outputs in source.md and document
      that context access is via `requires.context`
- [x] Add SRC-* invariants to invariants/INDEX.md
...
| Field | compute.md (amended) | Runtime mapping (execute.rs) | Status |
|-------|----------------------------|------------------------------|--------|
...
- [x] Update compute.md
- [x] Add CMP-* invariants to invariants/INDEX.md
...
| Field | trigger.md | Code (TriggerValueType) | Roadmap | Action |
|-------|-------------------|-------------------------|---------|--------|
...
- [x] Add TRG-* invariants to invariants/INDEX.md
...
- [x] Update action.md
- [x] Add ACT-* invariants to invariants/INDEX.md
...
- [x] Enforcement table in `cluster-spec.md`
...
**Location:** Add to cluster-spec.md or concepts.md
...
`authoring_path` is `Vec<(ClusterId, NodeId)>` as defined in cluster-spec.md §7.2.
...
- [x] Documentation in cluster-spec.md
...
- **v1 alpha:** Frozen documents remain immutable; v1 contracts live in stable docs
- Adapter contract v1 is authored in adapter.md
- Primitive manifest contracts are stable (additive preferred, breaking allowed in alpha)
- New invariants added to invariants/INDEX.md
...
- `orchestration/adapter.md` — Adapter contract v0 (frozen)
- `orchestration/supervisor.md` — Supervisor contract v0 (frozen, provenance rule source)
- adapter.md — Adapter contract v1 (to be authored)
- source.md — Source contract
- compute.md — Compute contract
- trigger.md — Trigger contract
- action.md — Action contract
- `authoring/cluster-spec.md` — Cluster contract
- `invariants/INDEX.md` — Enforcement loci
