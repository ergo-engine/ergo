...
2. [ontology](system/ontology.md) — The four primitives and their causal roles
3. [execution](system/execution.md) — How graphs evaluate
4. [freeze](system/freeze.md) — What is frozen vs patchable
5. [cluster-spec](authoring/cluster-spec.md) — Data structures for composition
6. [ui-runtime](contracts/ui-runtime.md) — What a UI must emit
7. [concepts](authoring/concepts.md) — Cluster composition concepts
8. [invariants](invariants/INDEX.md) — Enforcement loci for all invariants
9. [terminology](system/terminology.md) — Canonical terms and usage
...
|-----------|---------|----------|
| [system/](system/) | Core laws and identity | Ontology, execution model, freeze declaration, kernel closure, terminology |
...
| **CANONICAL** | Tracks implementation | [kernel](system/kernel.md), [terminology](system/terminology.md), [loader](authoring/loader.md), [invariants/](invariants/) (all phase files + INDEX) |
