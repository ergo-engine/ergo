...
Scope note: this generated index covers code-defined rule entries; broader cross-phase doctrine and governance constraints remain authoritative in `docs/invariants/*.md`.
